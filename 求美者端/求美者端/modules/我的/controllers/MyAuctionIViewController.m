...
@interface MyAuctionIViewController ()
...
@implementation MyAuctionIViewController

+ (instancetype)viewController
{
    MyAuctionIViewController* ctrl=[[self class] viewControllerWithStoryboardName:@"Mine"];
    return ctrl;
}
...
{
    MyAuctionSubViewController* sub = [self.storyboard instantiateViewControllerWithIdentifier:[MyAuctionSubViewController className]];
    sub.itemTag =  index;
    [sub setParent:self];
    return sub;
}
