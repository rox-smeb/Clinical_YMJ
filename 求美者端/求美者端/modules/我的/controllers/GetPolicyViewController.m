...
@interface GetPolicyViewController ()
...
@implementation GetPolicyViewController

+ (instancetype)viewController
{
    GetPolicyViewController* ctrl=[[self class] viewControllerWithStoryboardName:@"Mine"];
    return ctrl;
}
...
{
    GetPolicySubViewController* sub = [self.storyboard instantiateViewControllerWithIdentifier:[GetPolicySubViewController className]];
    sub.itemTag =  index;
    [sub setParent:self];
    return sub;
}
