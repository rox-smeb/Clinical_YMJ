...
// button border color
@property (strong, nonatomic)   UIColor         *doButtonBorderColor;
@property (strong, nonatomic)   UIColor         *doCancelBorderColor;
@property (strong, nonatomic)   UIColor         *doDestructiveBorderColor;

// button border width
@property (assign, nonatomic)   CGFloat         doButtonBorderWidth;
@property (assign, nonatomic)   CGFloat         doCancelBorderWidth;
@property (assign, nonatomic)   CGFloat         doDestructiveBorderWidth;
