...
-(SCLAlertViewResponder *)showTitle:(UIViewController *)vc title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    if(completeText != nil)
    {
        SCLButton* btn = [self addButton:completeText target:self selector:@selector(hideView)];
        btn.isCompleteButton = YES;
    }
    ...
    for (SCLButton *btn in _buttons)
    {
        ...
        if (btn.isCompleteButton)
        {
            if (self.closeButtonColor != nil)
            {
                btn.backgroundColor = self.closeButtonColor;
            }
            else
            {
            ...
            if (self.closeTitleColor != nil)
            {
                [btn setTitleColor:self.closeTitleColor forState:UIControlStateNormal];
                [btn setTitleColor:self.closeTitleColor forState:UIControlStateHighlighted];
            }
        }
        else
        {
            if (btn.bkColor != nil)
            {
                btn.backgroundColor = btn.bkColor;
            }
            else
            {
                btn.backgroundColor = viewColor;
            ...
            {
                [btn setTitleColor:btn.titleColor forState:UIControlStateNormal];
                [btn setTitleColor:btn.titleColor forState:UIControlStateHighlighted];
            }
        }
    }
