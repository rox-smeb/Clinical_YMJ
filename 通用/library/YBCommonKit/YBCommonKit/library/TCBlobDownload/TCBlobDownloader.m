...
- (void)onAppWillTerminate:(NSNotification*)notifi
{
    [self saveToFile];
    [self.file closeFile];
}
...
- (void)clearReceivedDataBuffer
{
    ...
    {
        [self.receivedDataBuffer resetBytesInRange:NSMakeRange(0, self.receivedDataBuffer.length)];
        [self.receivedDataBuffer setLength:0];
    }
}
...
- (void)start
{
    ...
    else
    {
        ...
        [self.fileRequest setValue:@"Mon, 25 Apr 2016 08:31:39 GMT" forHTTPHeaderField:@"If-Range"];
