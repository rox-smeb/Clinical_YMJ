...
- (void)setButtonTitleColor:(UIColor*)titleColor font:(UIFont*)font backgroundColor:(UIColor*)backgroundColor borderColor:(UIColor*)borderColor atIndex:(NSUInteger)index
{
    if (index < self.buttons.count) {
        UIButton *button = self.buttons[index];
