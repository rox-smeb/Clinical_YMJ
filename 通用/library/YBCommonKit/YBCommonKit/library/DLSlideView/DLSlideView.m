...
- (void)switchTo:(NSInteger)index{
    ...
    if (oldCtrl_ != nil && oldCtrl_.parentViewController == self.baseViewController) {
        ...
        [self.baseViewController transitionFromViewController:oldvc toViewController:newvc duration:self.transitionDur options:self.transitonOptions animations:^{
