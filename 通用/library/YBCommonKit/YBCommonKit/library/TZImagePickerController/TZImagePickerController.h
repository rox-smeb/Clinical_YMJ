...
/// Default is YES.if set NO, user can't picking more when exceed max count, and alert warning dialog.
/// 默认为YES，如果设置为NO,当用户已经选择最大数量的图片时,无法继续选择.并会弹出警告对话框
@property (nonatomic, assign) BOOL allowPickingMoreWhenExceedMax;
