...
- (BOOL)shouldStickHeaderToTopInSection:(NSUInteger)section
{
    ...
    if ([self.collectionView.delegate conformsToProtocol:@protocol(CHTCollectionViewDelegateWaterfallLayout)])
    {
        id<CHTCollectionViewDelegateWaterfallLayout> stickyHeadersDelegate=(id<CHTCollectionViewDelegateWaterfallLayout>)self.collectionView.delegate;
